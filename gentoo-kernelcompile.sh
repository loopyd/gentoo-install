...
echo 'Injecting package.use for dracut...'

echo 'Emerging dracut...'
emerge dracut lvm2 xfsprogs e2fsprogs
...
echo 'Emerging OpenRC...'


# Bootloader installation
echo 'Emerging grub and filesystem dependencies...'
emerge sys-boot/grub:2 os-prober sys-apps/usbutils sys-apps/hwinfo sys-fs/dosfstools xfsprogs e2fsprogs
